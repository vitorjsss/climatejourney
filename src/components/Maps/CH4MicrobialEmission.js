...
const CH4MicrobialEmission = () => {
    ...
    useEffect(() => {
        const fetchMap = async () => {
            try {
                const response = await fetch('https://back-service-8z96.onrender.com/api/v1/maps/methane-emissions/microbial', {
                    method: 'GET',
                    headers: {
            ...
            <div dangerouslySetInnerHTML={{ __html: mapHTML }} style={{ width: '100%', height: '100%' }} />
            {
                !loading && mapHTML && (
                    <div style={{
                        ...
                        <h4>Microbial Fuel CO₂ Emissions Map</h4>
...
export default CH4MicrobialEmission;
