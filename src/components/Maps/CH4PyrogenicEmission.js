...
const CH4PyrogenicEmission = () => {
    ...
    useEffect(() => {
        const fetchMap = async () => {
            try {
                const response = await fetch('https://back-service-8z96.onrender.com/api/v1/maps/methane-emissions/pyrogenic', {
                    method: 'GET',
                    headers: {
...
export default CH4PyrogenicEmission;
